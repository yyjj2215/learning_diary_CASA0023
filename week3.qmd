...
```{r echo=FALSE, out.width = "50%", fig.align='left', cache=FALSE, fig.cap= "Whishbroom. Source: [wikipedia](https://en.wikipedia.org/wiki/Whisk_broom_scanner)"}
knitr::include_graphics('week3_data/whiskbroom.gif') 
```

```{r echo=FALSE, out.width = "50%", fig.align='left', cache=FALSE, fig.cap= "Pushbroom. Source: [wikipedia](https://en.wikipedia.org/wiki/Push_broom_scanner)"}
