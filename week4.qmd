...
This study conducted by @wu2008 developed a computer program, which virtually planted three types of trees(small, medium, and large trees) in Los Angeles by using satellite data. It can iterativelly find the potential planting areas, and this would be really useful for planting department in every city. The planting department can combine the virtually planting sites with the real site conditions to plant a new tree for city.
